...
#https://www.journals.uchicago.edu/doi/suppl/10.1086/708857 - Internet Appendix - Section G - Moral Foundations Dictionary


care={
    "virtue":
    """
    safe*, peace*, compassion*, empath*, sympath*, care, caring,
    protect*, shield, shelter, amity, secur*, benefit*, defen*, guard*, preserve
    """,

    "vice":
    """
    harm*, suffer*, war, wars, warl*, warring, fight*, violen*, hurt*,
    kill, kills, killer*, killed, killing, endanger*, cruel*, brutal*, abuse*, damag*, ruin*, ravage,
    detriment*, crush*, attack*, annihilate*, destroy, stomp, abandon*, spurn, impair,
...
fairness={
    "virtue":
    """
    fair, fairly, fairness, fair-*, fairmind*, fairplay, equal*,
    justice, justness, justifi*, reciproc*, impartial*, egalitar*, rights, equity, evenness, equivalent,
    unbias*, tolerant, equable, balance*, homologous, unprejudice*, reasonable, constant,
    honest*
    """,

    "vice":
    """
    unfair*, unequal*, bias*, unjust*, injust*, bigot*, discriminat*,
    disproportion*, inequitable, prejud*, dishonest, unscrupulous, dissociate, preference,
    favoritism, segregat*, exclusion, exclud*
    """,
    }
...
ingroup={
    ...
    group, loyal*, patriot*, communal, commune*, communit*, communis*, comrad*,
    ...
    "vice":
    """
    foreign*, enem*, betray*, treason*, traitor*, treacher*, disloyal*,
    individual*, apostasy, apostate, deserted, deserter*, deserting, deceiv*, jilt*, imposter,
    miscreant, spy, sequester, renegade, terroris*, immigra*, abandon*
    """,
    }
...
authority={
    "virtue":
    """
    obey*, obedien*, duty, law, lawful*, legal*, duti*, honor*,
    ...
    "vice":
    """
    defian*, rebel*, dissent*, subver*, disrespect*, disobe*,
...
purity={
    "virtue":
    """
    piety, pious, purity, pure*, clean*, steril*, sacred*, chast*,
    holy, holiness, saint*, wholesome*, celiba*, abstention, virgin, virgins, virginity, virginal,
    austerity, integrity, modesty, abstinen*, abstemiousness, upright, limpid, unadulterated,
    maiden, virtuous, refined, decen*, immaculate, innocent, pristine, church*,
    preserve
    """,

    "vice":
    """
    disgust*, deprav*, disease*, unclean*, contagio*, indecen*,
